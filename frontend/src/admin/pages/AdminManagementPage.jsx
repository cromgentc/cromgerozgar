...
const configs = {
  ...
  companies: {
    ...
    subtitle: 'Review company profiles, verify documents, and control employer access.',
  ...
  employers: {
    ...
    subtitle: 'Approve accounts, verify documents, edit details, and block employers.',
    actionLabel: 'Add Employer',
    modalTitle: 'Add / Edit Employer',
    extra: 'Approve',
    columns: [
      { key: '_id', label: 'Employer ID' },
    ...
    fields: [['companyName', 'Employer name'], ['businessEmail', 'Business email'], ['phone', 'Phone'], ['industry', 'Industry'], ['companySize', 'Company size'], ['website', 'Website'], ['location', 'Location'], ['status', 'Status']],
  },
  candidates: {
    resource: 'candidates',
  ...
  payments: {
    ...
    extra: 'Invoice',
    export: true,
    columns: [{ key: 'invoiceNo', label: 'Invoice' }, { key: 'employer', label: 'Employer' }, { key: 'plan', label: 'Plan' }, { key: 'amount', label: 'Amount' }, { key: 'status', label: 'Status', badge: true }],
    fields: [['invoiceNo', 'Invoice number'], ['employer', 'Employer'], ['plan', 'Plan'], ['amount', 'Amount'], ['status', 'Payment status']],
  },
  reports: {
    resource: null,
    title: 'Reports',
    subtitle: 'Daily, weekly, monthly, employer-wise, job-wise, and candidate-wise reports.',
